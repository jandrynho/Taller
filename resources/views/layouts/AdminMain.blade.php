...
<body class="nav-md">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-money"></i>Rol de Pago <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="/welcomeAdmin/CategoriaProductos/create">Ingresar nuevo</a>
                    </li>
                </ul>
                </li>
                ...
                <li><a><i class="fa fa-industry"></i>  Maquinarias <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="/welcomeAdmin/Comunidades/create">Ingresar nueva</a>
                    </li>
                    <li><a href="form_advanced.html">Adminitrar Maquinarias</a>
                    </li> 
                  </ul>
                </li>
                <li><a><i class="fa fa-user"></i>Empleados<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="form_advanced.html">Adminitrar Empleados</a>
                    </li> 
                  </ul>
                </li>
                <li><a><i class="fa fa-cubes"></i> Materias Primas <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="form_advanced.html">Adminitrar Materias Primas</a>
                    </li>
                  </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="{{asset('admin/images/user.png')}}" alt="">jhony Guaman and jandry navarrtete
  ...
  {!!Html::script('js/Bloopets_Admin_Script.js')!!}
  <!-- gauge js -->
